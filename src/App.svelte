    ...
    <div class="h-full">
      ...
      >
        ...
        >
          ...
          >
            Nosso dever é fazer o melhor com a tecnologia de ponta!
          </p>
          ...
          >
            <div class="mb-4">
              ...
              <input
                id="name"
                type="email"
                placeholder="voce@lugar.com.br"
                class="input input-primary shadow appearance-none border rounded w-full p-3 text-gray-100 leading-tight focus:ring transform transition hover:scale-105 duration-300 ease-in-out"
              />
            </div>
        ...
        <div class="w-full xl:w-3/5 p-12 overflow-hidden">
          <img
            class="mx-auto w-full md:w-4/5 transform -rotate-12 ransition hover:scale-105 duration-700 ease-in-out hover:rotate-0"
            src="macbook.svg"
            alt="apresentação"
          />
        </div>
        ...
        <div class="mx-auto md:pt-16">
          ...
          <div
            class="flex space-x-20 w-full justify-start md:justify-start pb-24 lg:pb-0 fade-in"
          >
            <a
              class="w-60 text-blue-100 font-bold pb-8 lg:pb-6 text-center"
              href="https://www.linkedin.com/in/jgabrielgruber"
              target="_blank"
            >
              José Gabriel Gruber
            </a>
            <a
              class="w-60 text-blue-100 font-bold pb-8 lg:pb-6 text-center"
              href="https://www.linkedin.com/in/josneidrosdek"
              target="_blank"
            >
              Josnei Drosdek
            </a>
